...
def plot_to_png(Breuer2009_all_data, Rapp2009_all_data, lethe_all_data, lethe_all_data_2, data_type, x_values, labels,
    ...
    if zoom_in == True:
        ...
        sub_axes.append(inset_axes(axs[3][0], height = "30%", width = "30%", loc = location))
        ...
        sub_axes.append(inset_axes(axs[3][1], height = "30%", width = "30%", loc = location))
    ...
    axs[0][0].set_title("Lethe (250K)")
    axs[0][1].set_title("Lethe (1M)")
    fig.tight_layout()
