...
path_to_save = "../output_geometry/comparison_gls/"
...
labels = ["Lethe SUPG/PSPG", "Lethe GLS"]


# File names of lethe data
file_names_lethe_data = ["0.025_120K_300s_5600_q2q2", "0.025_120K_400s_5600_q2q2_gls"]
...
def plot_onto_geometry(x_available, Re, all_x_data, folder_to_save, x_vector, y_bottom, y_top, scale_factor,
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(folder_to_save + "2_data_in_geometry_" + str(data_type) + "_" + str(Re) +".png", dpi=800, bbox_inches='tight',pad_inches = 0)
    # plt.close(fig)
    ax.clear()
